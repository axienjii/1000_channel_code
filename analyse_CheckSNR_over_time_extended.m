function analyse_CheckSNR_over_time_extended
%20/12/19
...
saveFileName='X:\best\results\allSNR_260419_B1_dateVals.mat';
formatIn = 'ddmmyy';
loadRaw=0;
allSNR=[];
xval=[];
...
for dates=[1 4 6 9 11 16:18 20:22 25:28 31 33:34 36]%remove dates when two occur very close together
    switch(dates)
        case 1
            date='040717_B2';
            whichDir=2;
        ...
        case 28
            ...
            best=1;
        case 29
            date='050918_B2';%only on instances 1 and 2
            whichDir=2;
            best=1;
        case 30
            date='280918_B4';
        ...
        case 31
            ...
            best=1;
        case 32
            date='061118_B1';%only on instance 1
            whichDir=2;
            best=1;
        case 33
            date='181218_B4';
        ...
        case 34
            ...
            best=1;
        case 35
            date='080319_B6';%only on instances 1 and 2
            whichDir=2;
            best=1;
        case 36
            date='170419_B1';
            ...
            best=1;
        case 37
            date='260419_B1';%only on instances 1 and 2
            whichDir=2;
            best=1;
    end
    if whichDir==1
...
tally
figure;bar(xval-surgery,tally,'FaceColor',[0.5 0.5 0.5],'EdgeColor',[0.5 0.5 0.5])
ylim([0 1024]);
...
yVals=xVals*-0.013039834222720+14.893976713468879;%as calculated and returned in dlm.Coefficients
plot(xVals,yVals,'b-');
...
dfWithin=table{3,3};
Fstat=table{2,5};
sprintf(['F(',num2str(dfBetween),',',num2str(dfWithin),') = ',num2str(Fstat),', p = %.4f'],p)%F(1,4094) = 1504.5765, p = 0.0000
figure;
