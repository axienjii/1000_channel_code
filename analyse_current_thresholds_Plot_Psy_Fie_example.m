...
a=CurrentVals(1):0.01:CurrentVals(end);
Perf2 = LumWeibull(a, x(1), x(2), x(3), x(4));
ind50=find(Perf2<=0.5);
threshold50=a(ind50(end))
plot([0 threshold50],[0.5 0.5]);
hold on
plot([threshold50 threshold50],[0 0.5]);
