function render_bar_sweep_task3
...
%Uses images with higher contrast between head post and rest of image.

for monkeyInd=[1 2]
    if monkeyInd==1%Lick
        A = imread('D:\data\barsweep_video_in_setup\lick_realistic_skin_intact11_2.jpg');
        rootDir='D:\data';
        remoteDir='X:\best';
    elseif monkeyInd==2%Aston
        A = imread('D:\aston_data\barsweep_video_in_setup\aston_realistic_skin_intact11_2.jpg');
    ...
    if drawFrames==1
        ...
        for stimCond=1:4
            ...
            pathname=[rootDir,'\barsweep_video_in_setup\setup 1024-channel responses to bar sweeping ',direct{stimCond},'_2.mat'];
    ...
    if makeIndividualMovies==1
        for stimCond=1:4
            ...
            moviename=[rootDir,'\barsweep_video_in_setup\setup 1024-channel responses to  bar sweeping ',direct{stimCond},'3.avi'];
...
%                     framesResponse(timePoint).cdata=framesResponse(timePoint-1).cdata;
            ...
            moviename=[rootDir,'\barsweep_video_in_setup\setup 1024-channel responses to  bar sweeping ',direct{stimCond},'_2'];
...
%Lick:
moviename='D:\aston_data\barsweep_video_in_setup\setup 1024-channel responses to sweeping bar_both_monkeys_2';
if realtime==0
...
for dissolveInd=1:11%dissolve skin
    A = imread(['D:\data\barsweep_video_in_setup\lick_realistic_skin_intact',num2str(dissolveInd),'_2.jpg']);
    image(A);
    set(gcf,'PaperPositionMode','auto','Position',get(0,'Screensize'))
    set(gca,'LooseInset',get(gca,'TightInset'))
    set(gca,'visible','off')
...
for stimCond=1:4
    pathname=['D:\data\barsweep_video_in_setup\setup 1024-channel responses to bar sweeping ',direct{stimCond},'_2.mat'];
    load(pathname)
...
figure;
for dissolveInd=1:11%dissolve skin
    A = imread(['D:\aston_data\barsweep_video_in_setup\aston_realistic_skin_intact',num2str(dissolveInd),'_2.jpg']);
    image(A);
    set(gcf,'PaperPositionMode','auto','Position',get(0,'Screensize'))
    set(gca,'LooseInset',get(gca,'TightInset'))
    set(gca,'visible','off')
...
for stimCond=1:4
    pathname=['D:\aston_data\barsweep_video_in_setup\setup 1024-channel responses to bar sweeping ',direct{stimCond},'_2.mat'];
    load(pathname)
