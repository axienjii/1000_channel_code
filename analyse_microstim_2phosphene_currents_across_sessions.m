function analyse_microstim_2phosphene_currents_across_sessions(date)
%2/2/18
...
%as (difference in) current level delivered through pair of electrodes on the cortex. 
%Output is saved in .mat files, 220118_2phosphene_current_perf.mat
%and 040118_2phosphene_current_perf.mat, which is further processed
%by the function analyse_2phosphene_correlation_current_level.m.
allInstanceInd=1;
