function analyse_microstim_letter_across_sessions_visual_easy(date)
%27/2/18
...
for calculateVisual=1
    for setNo=1:29%[1:6 9 17:24 26 28:29]%1:29%[1:11 13:26 28:29]%1:24 for 10 electrodes per letter; subsequent sessions use 15 electrodes per letter
        perfNEV=[];
        timeInd=[];
        encodeInd=[];
        microstimTrialNEV=[];
        ...
        elseif calculateVisual==1
            ...
            switch(setNo)
                %visual task only:
                case 1
                    date='151118_B1';%next batch of new electrode combinations
                ...
                case 24
                    ...
                    visualOnly=1;
                case 25
                    date='191118_B7';%15 electrodes per letter, coloured dots
