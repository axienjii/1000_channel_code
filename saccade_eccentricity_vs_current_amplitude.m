...
%Lick data (varying pulse frequency)
dates=[{'010719_B6'} {'010719_B10'}];% {''} {''} {''} {''}
rootdir='D:\data\';
figure;
hold on
subplotInd=1;
...
dates=[{'010719_B5'} {'010719_B9'} {'010719_B11'}];% {''} {''} {''}
figure;
hold on
subplotInd=1;
for dateInd=1:length(dates)
...
%Aston data (varying pulse frequency)
...
dates=[{'040319_B6'} {'040319_B9'} {'050319_B3'} {'050319_B5'} {'280619_B2'} {'280619_B4'}];%{'040319_B5'} 
figure;
hold on
subplotInd=1;
for dateInd=1:length(dates)
