...
%             plot([0 0],[6.5 8],'color','black','linewidth',6)
%             plot([-0.4 0.05],[7.6 8],'color','black','linewidth',6)
%             plot([0.4 -0.05],[7.6 8],'color','black','linewidth',6)
...
%                 plot(elecRFs.x(thisStimElec),elecRFs.y(thisStimElec),'o','color',[1 0 0],'linewidth',1.8)
%                 if mod(totalFrame,2) == 0
