...
if saveEyeData==1
    ...
    save(['D:\data\',date,'\',instanceName,'_NSch_eye_channels_position.mat'],'NSch');
else
    load(['D:\data\',date,'\',instanceName,'_NSch_eye_channels_position.mat'],'NSch');
end
...
title('Y position')
set(gcf,'PaperPositionMode','auto','Position',get(0,'Screensize'))
pathname=fullfile('D:\data',date,[instanceName,'_eye_position']);
print(pathname,'-dtiff');