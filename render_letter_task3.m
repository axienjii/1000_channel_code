function render_letter_task3(movieVersion)
%Written by Xing 16/6/20. Read in images of monkeys in setup, identify
...
%centres, and eye movements. Uses images of monkeys in setup after contrast
%adjustment of the head post (previously, head post was distractingly
%low-contrast).
...
%                 FrameData(:,:,:,totalFrame) = X;
        ...
        pathname=['D:\data\letter_video_in_setup\setup 1024-channel letter',num2str(movieVersion),'_2.mat'];
    ...
    if makeIndividualMovies==1
        ...
        moviename=['D:\data\letter_video_in_setup\setup 1024-channel letter',num2str(movieVersion),'_2.avi'];
        ...
        moviename=['D:\data\letter_video_in_setup\setup 1024-channel letter',num2str(movieVersion),'_2'];
